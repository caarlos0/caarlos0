...
- [newrelic/newrelic-client-go](https://github.com/newrelic/newrelic-client-go) ([v0.46.0](https://github.com/newrelic/newrelic-client-go/releases/tag/v0.46.0), 1 day ago) - New Relic Client for the Go programming language
- [caarlos0/env](https://github.com/caarlos0/env) ([v6.4.0](https://github.com/caarlos0/env/releases/tag/v6.4.0), 1 day ago) - Simple lib to parse environment variables to structs
- [hashicorp/terraform](https://github.com/hashicorp/terraform) ([v0.14.0-beta1](https://github.com/hashicorp/terraform/releases/tag/v0.14.0-beta1), 1 day ago) - Terraform enables you to safely and predictably create, change, and improve infrastructure. It is an open source tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
- [charmbracelet/glow](https://github.com/charmbracelet/glow) ([v1.0.2](https://github.com/charmbracelet/glow/releases/tag/v1.0.2), 2 days ago) - Render markdown on the CLI, with pizzazz! 💅🏻
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([v0.145.0](https://github.com/goreleaser/goreleaser/releases/tag/v0.145.0), 3 days ago) - Deliver Go binaries as fast and easily as possible
- [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) ([kube-prometheus-stack-10.1.0](https://github.com/prometheus-community/helm-charts/releases/tag/kube-prometheus-stack-10.1.0), 3 days ago) - Prometheus community Helm charts
