...
- [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) ([kube-prometheus-stack-9.4.6](https://github.com/prometheus-community/helm-charts/releases/tag/kube-prometheus-stack-9.4.6), 1 day ago) - Prometheus community Helm charts
- [newrelic/newrelic-client-go](https://github.com/newrelic/newrelic-client-go) ([v0.44.0](https://github.com/newrelic/newrelic-client-go/releases/tag/v0.44.0), 2 days ago) - New Relic Client for the Go programming language
- [goreleaser/goreleaser-action](https://github.com/goreleaser/goreleaser-action) ([v2.2.1](https://github.com/goreleaser/goreleaser-action/releases/tag/v2.2.1), 3 days ago) - :octocat: GitHub Action for GoReleaser
- [GoogleContainerTools/kaniko](https://github.com/GoogleContainerTools/kaniko) ([v1.2.0](https://github.com/GoogleContainerTools/kaniko/releases/tag/v1.2.0), 3 days ago) - Build Container Images In Kubernetes
...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([v0.143.0](https://github.com/goreleaser/goreleaser/releases/tag/v0.143.0), 4 weeks ago) - Deliver Go binaries as fast and easily as possible
