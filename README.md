...
- [newrelic/newrelic-client-go](https://github.com/newrelic/newrelic-client-go) ([v0.35.1](https://github.com/newrelic/newrelic-client-go/releases/tag/v0.35.1), 1 day ago) - New Relic Client for the Go programming language
...
- [goreleaser/nfpm](https://github.com/goreleaser/nfpm) ([v1.5.0](https://github.com/goreleaser/nfpm/releases/tag/v1.5.0), 2 weeks ago) - NFPM is Not FPM - a simple deb and rpm packager written in Go
